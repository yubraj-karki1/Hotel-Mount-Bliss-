...
export interface Room { _id?: string; id?: string; name: string; type: string; description?: string; capacity: number; bed: string; price: number; status: RoomStatus; amenities: string[]; images?: string[]; floor: number }
